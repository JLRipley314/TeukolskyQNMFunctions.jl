...
"""
function mat_Y(nl::myI, s::myI, m::myI)::SparseMatrixCSC
...
"""
function mat_L(nl::myI, s::myI, m::myI)::SparseMatrixCSC
...
"""
function compute_M_matrix(nl::myI, s::myI, m::myI, c::myC)
    ...
    return sparse(transpose(-(c^2) * Y2 + tomyF(2) * c * s * Y1 + L))
...
(λs, vs)
"""
function eig_vals_vecs(nl::myI, neig::myI, s::myI, m::myI, c::myC)
